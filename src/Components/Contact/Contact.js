...
const Contact = () => {
    return (
      ...
      <div class = "contact-bg">
        ...
        <p class = "text">“To be a doctor, Thats  means much more than to dispense pills or to patch up or repair torn flesh and shattered minds. To be a doctor is to be an intermediary between man and GOD” (Felix Marti-Ibanez in To Be a Doctor).</p>
      </div>
      ...
      <div class = "contact-body">
        <div class = "contact-info">
          <div>
            ...
            <span>Phone No.</span>
            <span class = "text">01761926292</span>
          </div>
          <div>
            <span><i class = "fas fa-envelope-open"></i></span>
            <span>E-mail</span>
            <span class = "text">mohammad15-2051@diu.edu.bd</span>
          </div>
          <div>
